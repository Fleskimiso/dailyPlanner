...
import { DayPlanModel } from "../models/PlanModel";
...
import { loginFormSchema, registerFormSchema } from "../validators/user";
...
export const registerController =async (req:Request<{},{},IRegisterRequest>, res:Response<IErrorResponse>) =>{
    try {
